...
class Autoload
{
    ...
    public static function setNamespaces()
    {
        static::$pathToNamespaces = [
            ...
            'Lib\Exception\Model' => 'lib/Exception/Model',
            'Lib\Exception\Response' => 'lib/Exception/Response',
            'Lib\Exception\Routing' => 'lib/Exception/Routing',
            'Lib\Exception\Security' => 'lib/Exception/Security',
            'Lib\Form' => 'lib/Form',
            'Lib\Http' => 'lib/Http',
            'Lib\Model' => 'lib/Model',
